...
public final class Board extends Prototype<Board> {
    ...
    private String name; // usunęliśmy specyfikator final z pola name; dodaliśmy setter do tego pola;
    // możliwość ustawienia nowej wartości  po sklonowaniu obiektu klasy Board.
