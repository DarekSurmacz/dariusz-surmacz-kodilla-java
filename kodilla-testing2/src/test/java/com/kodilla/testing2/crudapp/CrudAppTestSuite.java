...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://dareksurmacz.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("dariuszsurmacz6@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("hasLo;21");
